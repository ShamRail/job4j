...
public class TrackerTest {
    ...
    public void whenAddThreeItemsAndDelOneItemThenTwoItem() {
        ...
        tracker.delete(id);
        Assert.assertThat(tracker.findAll().get(0).getCreate() + tracker.findAll().get(1).getCreate(),
                Is.is(1354L));
    }
    @Test
    public void whenReplaceOneItemThenItChanges() {
        ...
        Assert.assertThat(tracker.findAll().get(1).getName(), Is.is("new name"));
    }
    @Test
    ...
    public void whenItemsIsNotEmpyThenFindByNameReturnItemsSameName() {
        ...
        Assert.assertThat(result.get(0).getCreate() + result.get(1).getCreate(),
                Is.is(246L));
    }
