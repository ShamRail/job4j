    ...
    <form action="${pageContext.servletContext.contextPath}/signup" method="POST" id="f">
        <div class="container">
            ...
            <div id="sel_inf">
                ...
                <br>
                <select id="country" name="country" form="f" onchange="load()">
            ...
            <div class="clearfix">
                <button formaction="${pageContext.servletContext.contextPath}/login" formmethod="get" class="cancelbtn">Cancel</button>
